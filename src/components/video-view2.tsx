        ...
        <CardContent className="flex flex-row w-full h-full p-0">
          ...
          <div className="flex flex-col w-full h-full pl-4">
            ...
            <a
              ...
              className="flex flex-row items-center justify-start w-full h-8 mt-4 mb-1"
            >
            ...
            <p className="w-full h-4 mt-2 mb-2 overflow-hidden text-sm text-ellipsis">
              {vid.description}
            </p>
            {vid.category !== "" && (
              <a
                href={"/?cat=" + vid.category}
                className={
                  badgeVariants({ variant: "default" }) + " w-fit mt-2"
                }
              >
                {category}
              </a>
