        ...
        <CardContent className="flex flex-col w-full h-full p-0">
          ...
          <div className="flex flex-row w-full h-full gap-4">
            <a
              ...
              className="flex justify-center w-8 h-full col-span-1 mt-4 mb-1"
            >
            ...
            <div className="flex flex-col w-full h-full">
              {vid ? (
                <p
                  className="w-full overflow-hidden font-semibold text-ellipsis max-h-14 text-md"
                  title={vid.title}
                >
                  {vid.title}
                </p>
              ...
              {owner ? (
                <a
                  href={"/channel/" + owner?.$id}
                  className="text-xs text-slate-400 hover:text-inherit"
                >
                  {owner.username}
                </a>
              ) : (
