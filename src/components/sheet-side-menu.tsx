        ...
        <div className="flex flex-col w-full h-full gap-4 pt-1">
          <div className="flex flex-col w-full gap-2 h-fit">
            <a
              ...
              href="/"
              className={`flex flex-row items-center justify-start h-10 gap-2 p-2 rounded-lg lg:w-full ${
                page === "/" &&
            ...
            >
              <Home />
              <span className={`lg:block`}>Frontpage</span>
            </a>
            <a
              onClick={handleToggleMenu}
              href="/subscribed"
            ...
            >
              <GalleryVerticalEnd />
              <span className={`lg:block`}>Subscribed</span>
            </a>
            <a
              onClick={handleToggleMenu}
              href="/liked"
            ...
            >
              <ThumbsUp />
              <span className={`lg:block`}>Liked</span>
            </a>
          </div>
          <Separator />
          <div className="flex flex-col w-full gap-2 h-fit">
            <p className={`self-start pl-2 text-lg font-semibold lg:block`}>
              You
            </p>
            {channel !== undefined ? (
              <a
              ...
              >
                <SquareUserRound />
                <span className={`lg:block`}>Your Channel</span>
              </a>
            ) : (
              <a
                onClick={handleToggleMenu}
              ...
              >
                <SquareUserRound />
                <span className={`lg:block`}>Create Channel</span>
              </a>
            )}
            <a
              onClick={handleToggleMenu}
            ...
            >
              <History />
              <span className={`lg:block`}>History</span>
            </a>
          </div>
          <Separator />
          <div className="flex flex-col w-full gap-2 h-fit">
              ...
              subscribedTo[0].Channels.map((channel: any, index: number) => {
                ...
                return (
                  <a
                    onClick={handleToggleMenu}
                    href={"/channel/" + channel.$id}
                    className={`flex flex-row items-center justify-start h-10 gap-2 p-2 rounded-lg w-full ${
                      page === "channel/" + channel.$id &&
                      (theme === "dark" ? "bg-slate-800" : "bg-slate-200")
                    } ${
                      theme === "dark"
                  ...
                  >
                    ...
                    <span className={`w-full h-full break-all lg:block`}>
                      {channel.username}
                    </span>
                  </a>
                );
