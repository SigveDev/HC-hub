            ...
            <Card className="w-full aspect-[12/3] border-none">
                <CardContent className="flex flex-row w-full h-full p-0">
                    ...
                    <div className="flex flex-col w-full h-full pl-4">
                        ...
                        <a href={'/channel/' + owner?.$id} className="flex flex-row items-center justify-start w-full h-fit">
